...
@implementation FLTGoogleMapController {
    ...
    FLTGroundOverlayController* _groundOverlayController;
}
...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super init]) {
        ...
        _groundOverlayController = [[FLTGroundOverlayController alloc]init:_channel mapView:_mapView registrar:registrar];
        ...
        id goverlayToAdd = args[@"groundOverlaysToAdd"];
        if ([goverlayToAdd isKindOfClass:[NSArray class]])
        {
            [_groundOverlayController addGroundOverlays:goverlayToAdd];
        }
    }
    return self;
}
